...
public class AttributeDescriptionSet extends ComparableDescriptionSet<AttributeDescription> {
	...
	public boolean isIncludedIn(ComparableDescriptionSet<AttributeDescription> set) {
		if(set.first().getValue().containsAll(this.first().getValue())){
			return true;
		}
		else{
			return false;
	...
	public boolean includes(AttributeDescription desc) {
		if(this.first().getValue().contains(desc.getValue())){
			return true;
		}
		else{
			return false;
    ...
    public boolean equals(Object s){
	 if(this.first().getValue().equals(((AttributeDescriptionSet) s).first().getValue())){
			return true;
		}
		else{
			return false;
