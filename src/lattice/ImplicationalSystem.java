 ...
 * Therefore, the closed set lattice of an ImplicationalSystem can be generated by invoking method `closedSetLattice` of a closure system.
...
// search of x in S
     ...
     **/
    public static ImplicationalSystem randomIS(int nbS, int nbR) {
